...
class AgentDocumentationGeneratorTest {

    @Data
    @AgentConfiguration(description = "this agent is AWESOME!", name = "my super agent")
    ...
    public void test() throws Exception {
        ...
        final AgentConfigurationModel model =
                AgentDocumentationGenerator.readFromClass(MyClass.class);
        ...
        Assertions.assertEquals(
                ...
                AgentDocumentationGenerator.jsonWriter.writeValueAsString(model));
    }
}
