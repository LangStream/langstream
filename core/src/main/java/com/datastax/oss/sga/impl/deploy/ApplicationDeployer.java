...
public final class ApplicationDeployer {
     ...
     */
      public ExecutionPlan createImplementation(String applicationName, Application applicationInstance) {
          ...
          return clusterRuntime.buildExecutionPlan(applicationName, resolvedApplicationInstance, pluginsRegistry, streamingClusterRuntime);
      }
