...
public class TopicConnectionsRuntimeRegistry {
    ...
    protected final Map<String, TopicConnectionsRuntime> implementations =
    ...
    public TopicConnectionsRuntime getTopicConnectionsRuntime(StreamingCluster streamingCluster) {
        ...
        return implementations.computeIfAbsent(
                streamingCluster.type(), TopicConnectionsRuntimeRegistry::loadClusterRuntime);
    }
    ...
    private static TopicConnectionsRuntime loadClusterRuntime(String streamingClusterType) {
        ServiceLoader<TopicConnectionsRuntimeProvider> loader =
                ServiceLoader.load(TopicConnectionsRuntimeProvider.class);
        ServiceLoader.Provider<TopicConnectionsRuntimeProvider> clusterRuntimeProviderProvider =
                loader.stream()
                        ...
                        .orElseThrow(
                                () ->
                                        new RuntimeException(
                                                "No TopicConnectionsRuntimeProvider found for type "
