...
exec java ${JAVA_OPTS} -Dlogging.config=/app/logback.xml -Dlangstream.development.mode=true -Djdk.lang.Process.launchMechanism=vfork -cp "/app/lib/*" "ai.langstream.runtime.tester.Main"
